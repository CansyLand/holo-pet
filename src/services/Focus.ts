...
export class FocusService {
  ...
  // Update camera position between player and pet
  private updateCameraPosition(cameraEntity: any, entity: any) {
    const petTransform = Transform.get(entity)
    ...
    const petToPlayer = Vector3.subtract(playerPos, petPos)
    ...
    const cameraPos = Vector3.add(petPos, Vector3.scale(Vector3.normalize(petToPlayer), cameraDistanceFromPet))
